...
public class CreateStudentProfilePane extends GridPane {
	...
	public CreateStudentProfilePane() {
		...
		inputDate.setPromptText("Use the button -->");
	...
	public boolean hasEmptyFields() {
		if(txtFirstName.getText().equals("") || txtSurname.getText().equals("") || txtPnumber.getText().equals("") || txtEmail.getText().equals("") || inputDate.getValue() == null) {
			return true;
		} else {
		return false;
		}
	...
	public boolean isDateInPast() {
		...
		if (getStudentDate().isBefore(date)) {
			return true;
		} else {
			return false;
		}
